...
#     'kv_layer': {
#         'init_std':             lambda m, r: 1 / m**(1/2),
#         'lr_scale':             lambda m, r: ( 2**(1/2) + r**(1/2) ) / ( (2**(1/2) + 1) * m ),
#         'wd_scale':             lambda m, r: ( (2**(1/2) + 1) * m ) / ( 2**(1/2) + r**(1/2) ),
#         'output_multiplier':    lambda m, r: 1.0
#     },
#     'unembedding': {
#         'init_std':             lambda m: 1.0,
...
moe_base = {
    ...
    'moe_ffn_1': {
        'init_std':             lambda n, ffn_n, E, k: ffn_n**(1/2) / ( n**(1/2)*(ffn_n**(1/2) + n**(1/2)) ),
        'lr_scale':             lambda m, ffn_m, E, k: k**(1/2) * E**(1/2) / m * moe_normalization[(E, k)]['second_moment'] / (moe_normalization[(E, k)]['mean']),
        'wd_scale':             lambda m, ffn_m, E, k: m,
        'output_multiplier':    lambda m, ffn_m, E, k: 1.0
    },
    'moe_ffn_2': {
        'init_std':             lambda n, ffn_n, E, k: n**(1/2) / ( ffn_n**(1/2)*(ffn_n**(1/2) + n**(1/2)) ),
        'lr_scale':             lambda m, ffn_m, E, k: k * E**(1/2) / (ffn_m) * moe_normalization[(E, k)]['second_moment'] / (moe_normalization[(E, k)]['mean']),
...
moe_correction = lambda E, k: k**(1/2) * E**(1/2) * moe_normalization[(E, k)]['second_moment'] / (moe_normalization[(E, k)]['mean'])
...
moe_fsdp = {
    ...
    # },
    'moe_ffn_1': {
        'init_std':             lambda n, ffn_n, E, k: ffn_n**(1/2) / ( n**(1/2)*(ffn_n**(1/2) + n**(1/2)) ) / moe_correction(E, k),
        'lr_scale':             lambda m, ffn_m, E, k: 1 / m,
        'wd_scale':             lambda m, ffn_m, E, k: m,
        'output_multiplier':    lambda m, ffn_m, E, k: moe_correction(E, k)
    },
    'moe_ffn_2': {
        'init_std':             lambda n, ffn_n, E, k: n**(1/2) / ( ffn_n**(1/2)*(ffn_n**(1/2) + n**(1/2)) ) / moe_correction(E, k) * ffn_n / n,
        'lr_scale':             lambda m, ffn_m, E, k: 1 / m,
        'wd_scale':             lambda m, ffn_m, E, k: m,
        'output_multiplier':    lambda m, ffn_m, E, k: m * moe_correction(E, k) / ffn_m,
    },
    'normalization': {
        'lr_scale':             lambda m: 1.0 / m,
    },
