...
# NPROC_PER_NODE=8 # Assuming 8 GPUs per node as requested by --gres=gpu:8
...
# # If you don't have Infiniband, uncomment the following line
...
#      --compile=False # Add any other NanoGPT training arguments here