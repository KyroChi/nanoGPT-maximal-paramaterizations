...
wandb_run_name = 'gpt2-moe-124m-sigma'
...
moe_num_experts = [6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6]  # More experts in early/late layers
# Specify different top-k per layer (must have n_layer elements)
moe_num_experts_per_tok = [5, 5, 4, 3, 2, 1, 1, 1, 1, 1, 1, 1]  # Top-1 in middle layers
