...
class ModelConfig:
    ...
    dtype: str = 'bfloat16'
    sbatch_timeout: str = '05:00:00'
    warmup_ptc: float = 0.03
    ...
    def get_config(self, prod: bool):
        base_config = {
            ...
            'dtype': self.dtype,
            'sbatch_timeout': self.sbatch_timeout,
        }
        if prod:            
            prod_config = {
                ...
                'warmup_iters': int(self.warmup_ptc * self.prod_max_iters),
            }
        else:
            prod_config = {
                'sbatch_nodes': self.prod_sbatch_nodes,
                ...
                'sbatch_mem': self.prod_sbatch_mem,
                'enable_fsdp': self.enable_fsdp,
                'warmup_iters': int(self.warmup_ptc * self.noprod_max_iters),
            }
...
terminal_models = {
    '50m': ModelConfig(
        ...
        prod_sbatch_mem=256,
        enable_fsdp='true',
        sbatch_timeout='03:00:00',
    ),
    '100m': ModelConfig(
        wandb_run_name='hkm_100m',
        n_embd=768,
        n_layer=12,
        n_head=6,
        n_kv_head=3,
        ...
        prod_gradient_accumulation_steps=8,
        prod_batch_size=6,
        prod_max_iters=11851,
        prod_sbatch_mem=256,
        enable_fsdp='true',
        sbatch_timeout='04:00:00',
    ),
    '250m': ModelConfig(
        wandb_run_name='hkm_250m',
        n_embd=1024,
        n_layer=16,
        n_head=8,
        n_kv_head=4,
        prod_sbatch_nodes=2,
        prod_n_gpus=8,
        prod_gradient_accumulation_steps=16,
        prod_batch_size=5,
        prod_max_iters=16012,
        prod_sbatch_mem=256,
        enable_fsdp='true',
        sbatch_timeout='06:00:00',
    ),
    '500m': ModelConfig(
        wandb_run_name='hkm_500m',
        n_embd=1536,
        n_layer=16,
        n_head=12,
        n_kv_head=4,
        prod_sbatch_nodes=3,
        prod_n_gpus=8,
        prod_gradient_accumulation_steps=24,
        prod_batch_size=4,
        prod_max_iters=24414,
        prod_sbatch_mem=256,
        enable_fsdp='true',
        sbatch_timeout='16:00:00',
    ),
    '1b': ModelConfig(
        wandb_run_name='hkm_1b',
        n_embd=2048,
        n_layer=20,
        n_head=16,
        n_kv_head=8,
        prod_sbatch_nodes=4,
        prod_n_gpus=8,
        prod_gradient_accumulation_steps=32,
        prod_batch_size=5,
        prod_max_iters=31306,
        prod_sbatch_mem=256,
        enable_fsdp='true',
        sbatch_timeout='32:00:00',
    ),
    '3b': ModelConfig(
        wandb_run_name='hkm_3b',
        n_embd=3072,
        n_layer=24,
        n_head=24,
        n_kv_head=8,
        prod_sbatch_nodes=6,
        prod_n_gpus=8,
        prod_gradient_accumulation_steps=48,
        prod_batch_size=6,
        prod_max_iters=60489,
        prod_sbatch_mem=256,
        enable_fsdp='true',
    ),
}